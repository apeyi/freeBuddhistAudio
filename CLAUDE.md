...
- **Tabs**: Home · Search · Downloads · Donate · My FBA (Donate opens the web donation page; the Join page exists but is only reached via download gating). Recently listened lives on My FBA. Home is the spec v1.0 layout (Sangharakshita, Digital Legacy, Collections, Introductions/Meditations/Latest/Themes/Series/People/Places rows, Support, Connect). See `docs/spec-v1.0-pre-api.md`.
