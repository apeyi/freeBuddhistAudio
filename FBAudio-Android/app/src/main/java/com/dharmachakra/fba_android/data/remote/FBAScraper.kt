package com.dharmachakra.fba_android.data.remote

import com.dharmachakra.fba_android.domain.model.BrowseCategory
import com.dharmachakra.fba_android.domain.model.Checkpoint
import com.dharmachakra.fba_android.domain.model.DigitalLegacy
import com.dharmachakra.fba_android.domain.model.ListPage
import com.dharmachakra.fba_android.domain.model.MenuNode
import com.dharmachakra.fba_android.domain.model.CategoryType
import com.dharmachakra.fba_android.domain.model.SearchResult
import com.dharmachakra.fba_android.domain.model.Talk
import com.dharmachakra.fba_android.domain.model.Track
...
class FBAScraper @Inject constructor(
    ...
    private fun parseTalk(json: JsonObject, html: String = ""): Talk {
        ...
        val duration = (json.getInt("durationSeconds") ?: json.getInt("duration") ?: 0)
            .let { if (com.dharmachakra.fba_android.ui.player.PlaybackMath.isPlausibleDuration(it)) it else 0 }
    ...
    suspend fun fillMissingTrackDurations(talk: Talk): Talk {
        ...
        return withContext(Dispatchers.IO) {
            ...
            for ((i, bytes) in sizes) {
                val seconds = com.dharmachakra.fba_android.ui.player.PlaybackMath.estimateDurationSeconds(bytes, ref, reference.durationSeconds)
